##!/bin/bash
#
## This script is taken from https://www.reddit.com/r/Fedora/comments/123mhjn/comment/jdxls0z/
## It has not been set up, and as such, does not work. It is purely here
## for future reference when we need to create a GTK-4.0 theme switcher.
#
##!/bin/bash
#
